      ...
      <div className="relative  bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative m-3 flex flex-wrap mx-auto justify-center">
            {products &&
              ...
              products.map((product: any) => (
                ...
                <div key={product.id} className="relative max-w-sm min-w-[340px] bg-white shadow-md rounded-3xl p-2 mx-3 my-3 cursor-pointer">
                  ...
                  <div className="mt-4 pl-2 mb-2 flex justify-between ">
                    <div>
                      ...
                      <div className='flex '>
                        <p className="text-md text-gray-800 mt-0 mx-2 line-through">S/{product.compare_price}</p>
                        <p className="text-lg font-semibold text-gray-800 mt-0 mx-2">S/{product.price}</p>
                      </div>
          ...
          <section className="p-6 dark:bg-coolGray-800 dark:text-coolGray-100">
            ...
            <div className="container flex flex-wrap justify-center mx-auto dark:text-coolGray-400">
